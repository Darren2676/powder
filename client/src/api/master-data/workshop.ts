...
export const toggleWorkshopStatus = (id: string) => request.put(`/workshops/${encodeURIComponent(id)}/toggle-status`)
export const approveWorkshop = (id: string) => request.put(`/workshops/${encodeURIComponent(id)}/approve`)
export const withdrawWorkshop = (id: string) => request.put(`/workshops/${encodeURIComponent(id)}/withdraw`)
