...
export const approveWorkCenter = (id: string) => request.put(`/work-centers/${encodeURIComponent(id)}/approve`)
export const withdrawWorkCenter = (id: string) => request.put(`/work-centers/${encodeURIComponent(id)}/withdraw`)
