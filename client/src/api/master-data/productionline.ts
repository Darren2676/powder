...
export const toggleProductionlineStatus = (id: string) => request.put(`/productionlines/${encodeURIComponent(id)}/toggle-status`)
export const approveProductionline = (id: string) => request.put(`/productionlines/${encodeURIComponent(id)}/approve`)
export const withdrawProductionline = (id: string) => request.put(`/productionlines/${encodeURIComponent(id)}/withdraw`)
