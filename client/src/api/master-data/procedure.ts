...
export const approveProcedure = (id: string) => request.put(`/procedures/${encodeURIComponent(id)}/approve`)
export const withdrawProcedure = (id: string) => request.put(`/procedures/${encodeURIComponent(id)}/withdraw`)
