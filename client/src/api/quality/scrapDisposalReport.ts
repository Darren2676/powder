...
export function getScrapDisposalKPI(params?: { start_date?: string; end_date?: string }) {
  return request.get('/quality/scrap-disposal-report/kpi', { params })
}

export function getScrapDisposalChartData(params?: { start_date?: string; end_date?: string }) {
