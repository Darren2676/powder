...
export function getScrapOrderKPI(params?: { start_date?: string; end_date?: string; factory_id?: number }) {
  return request.get('/quality/scrap-order-report/kpi', { params })
}

export function getScrapOrderChartData(params?: { start_date?: string; end_date?: string; factory_id?: number }) {
