...
export function getScrapQualityStatsKPI(params?: { start_date?: string; end_date?: string }) {
  return request.get('/quality/scrap-quality-stats-report/kpi', { params })
}

export function getScrapQualityStatsChartData(params?: { start_date?: string; end_date?: string }) {
