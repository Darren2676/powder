...
import { getStandardCosts, getStandardCostDetail, createStandardCost, updateStandardCost, deleteStandardCost, exportStandardCosts, importStandardCost } from '@/api/purchasing/standardCost'
...
} = useColumnPreference('standard_cost_list', defaultDataColumns, {
