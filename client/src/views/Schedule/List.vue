...
import { getSchedules, createSchedule, updateSchedule, deleteSchedule, exportSchedules, importSchedules } from '@/api/schedule'
...
const handleDelete = (record: Schedule) => {
  Modal.confirm({
    ...
    content: `确定要删除班次"${record.schedules_name}"吗?`,
    okText: '确认',
    cancelText: '取消',
    onOk: async () => {
      try {
