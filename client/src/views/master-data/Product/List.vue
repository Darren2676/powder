...
import { getProducts, createProduct, updateProduct, deleteProduct, exportProducts, importProducts } from '@/api/master-data/product'
...
const { loading, dataSource, searchText, selectedRowKeys, pagination, rowSelection, fetchData, handleTableChange, handleSearch, handleReset } = useTableList<Product>(getProducts)
...
const handleExport = async () => {
  try {
    ...
    link.download = generateExportFilename('products')
    link.click()
