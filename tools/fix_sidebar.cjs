...
// Find the </a-sub-menu> that closes equipment-management, right before the system-settings sub-menu
...
// Find the </a-sub-menu> before this marker
...
// Replace the </a-sub-menu> before system-settings with new items + </a-sub-menu>
...
console.log('Menu items added successfully at position', subMenuCloseIdx);
