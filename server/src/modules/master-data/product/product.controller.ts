  ...
  try {
    ...
    await sequelize.query(insertSql, {
      replacements: {
        ...
        product_class_number: b.product_class_number || '',
        product_class_name: b.product_class_name || '',
        product_properties: b.product_properties || '',
        ...
        standard_pass_rate: b.standard_pass_rate || ''
      }
    });
...
export const updateProduct = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    await sequelize.query(updateSql, {
      replacements: { itemNumber, item_name: b.item_name, product_class_number: b.product_class_number, product_class_name: b.product_class_name, product_properties: b.product_properties, basic_unit: b.basic_unit, specifications: b.specifications, product_drawing_number: b.product_drawing_number, rubber_compound_number: b.rubber_compound_number, batch_production_quota: b.batch_production_quota, standard_pass_rate: b.standard_pass_rate }
    });
